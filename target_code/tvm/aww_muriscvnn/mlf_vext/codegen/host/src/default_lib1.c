...
TVM_DLL int32_t tvmgen_default___tvm_main__(int8_t* input_1_buffer_var, int8_t* Identity_buffer_var, uint8_t* global_const_workspace_0_var, uint8_t* global_workspace_1_var) {
  ...
  void* sid_49_let = (&(global_workspace_1_var[8000]));
  void* sid_42_let = (&(global_workspace_1_var[0]));
  void* sid_56_let = (&(global_workspace_1_var[0]));
  void* sid_35_let = (&(global_workspace_1_var[8000]));
  void* sid_63_let = (&(global_workspace_1_var[8000]));
  void* sid_21_let = (&(global_workspace_1_var[8000]));
  void* sid_28_let = (&(global_workspace_1_var[0]));
  void* sid_7_let = (&(global_workspace_1_var[8000]));
  void* sid_14_let = (&(global_workspace_1_var[0]));
  void* sid_64_let = (&(global_workspace_1_var[0]));
  void* sid_67_let = (&(global_workspace_1_var[64]));
